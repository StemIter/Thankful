...
export const GuidancePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-emerald-50 py-6">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-green-400 via-teal-400 to-emerald-400 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg p-5 animate-fade-in-up">
            <p className="text-gray-700 leading-relaxed text-sm">
              从开题思路到卡点突破，您的细致指导总能一针见血、点拨迷津。
              这份毫无保留的栽培，帮我夯实科研根基，稳步前行。
            </p>
          </Card>
